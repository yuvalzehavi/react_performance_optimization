...
const App = () => {
  return (
    <div>
      <StyledHeader>Parent-Child Relationship - Render Props</StyledHeader>
      <CodeDescription>
        <Typography>{`/////parent component`}</Typography>
        <Typography>{`const Parent = () => (`}</Typography>
        <Typography className={'indentedText'}>
          <span>{`const setChildValidationRef = useRef(null);`}</span>
          ...
          >{`setChildValidState(setChildValidationRef.current());`}</span>
          <span>{`}`}</span>
          <span>{`<Typography>{childValidState}</Typography>`}</span>
          <span>{`<Child`}</span>
          <span
            className={'indentedText'}
          >{` render={setChildValidation => {`}</span>
          <span
            className={'indentedText2'}
          >{`setChildValidationRef.current = setChildValidation;`}</span>
        ...
        <Typography>{`const Child = ({ render }) => {`}</Typography>
        <Typography className={'indentedText'}>
        ...
        <Typography>{`}`}</Typography>
        <Typography>{`return render(setChildValidation, validState)`}</Typography>
        <br />
      ...
      <DescriptionTypography variant={'subtitle2'}>
        Using Render Props pattern to activate validation function in child from parent
